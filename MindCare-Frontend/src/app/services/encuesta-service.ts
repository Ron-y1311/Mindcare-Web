...
export class EncuestaService {
  ...
  crearInicial(data: Encuesta): Observable<Encuesta>
  { return this.http.post<Encuesta>(`${this.url}/encuesta-inicial`, data);
  }
  ...
  listarResultados(pacienteId: number): Observable<Encuesta[]>
  { return this.http.get<Encuesta[]>(`${this.url}/paciente/${pacienteId}/resultados`);
  }
}
